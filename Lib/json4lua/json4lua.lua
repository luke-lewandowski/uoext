...
json.decode_scanArray = function(s,startPos)
...
json.decode_scanComment = function(s, startPos)
...
-- scanned.
json.decode_scanConstant = function(s, startPos)
...
json.decode_scanNumber = function(s,startPos)
...
json.decode_scanObject = function(s,startPos)
  local object = {}
  local stringLen = string.len(s)
  local key, value
...
json.decode_scanString = function(s,startPos)
...
-- was reached.
json.decode_scanWhitespace = function(s,startPos)
  local whitespace=" \n\r\t"
  local stringLen = string.len(s)
